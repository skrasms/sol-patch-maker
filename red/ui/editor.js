...
RED.editor = (function() {
	...
	function showEditDialog(node) {
        ...
        //Aaron's mod for Enter key handling
        $( "#dialog" ).submit(function(e) {
            //Submit can trigger a page reload, so intercept it here.
            e.preventDefault();
            //Locate the first button in the dialog box ("Ok") and click it.
            //click.apply(dialog) is used instead of just click() to work around
            //an issue with jquery context that I don't fully understand.
            $(this).dialog("option", "buttons")[0].click.apply(dialog);
        });
	}
